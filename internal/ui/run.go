...
func modelFor(
	...
	return NewModel(Deps{
		...
		Diff: d.Diff, Files: d.Files, Generated: d.Generated, Stat: d.Stat, Turn: d.Turn, PRs: d.PRs, Issues: d.Issues, Item: d.Item, Browse: d.Browse, Rename: d.Rename, Rebind: d.Rebind, RenameBranch: d.RenameBranch, Name: d.Name, ModelName: d.ModelName,
